...
function About() {
  return (
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-black dark:bg-black">
      ...
      <div className="relative z-10 max-w-lg p-6 text-center transition duration-500 transform shadow-lg shadow-green-lg sm:p-8 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 rounded-3xl hover:scale-105 sm:max-w-lg lg:max-w-xl sm:px-8 sm:py-3 sm:mt-6 sm:text-lg hover:shadow-lime-500/50">
        <div className="flex flex-col items-center">
          <div className="relative">
            <img
              src={imgone}
              alt="Profile"
              className="w-24 h-24 transition-all duration-500 border-4 border-green-400 rounded-full shadow-lg sm:w-32 sm:h-32 lg:w-40 lg:h-40 xl:w-48 xl:h-48 sm:shadow-xl hover:shadow-lime-500/50"
            />

            <div className="absolute top-0 left-0 w-full h-full border-4 rounded-full border-lime-500 animate-pulse"></div>
          </div>

          <h1 className="mt-4 text-3xl font-extrabold tracking-wide sm:mt-6 sm:text-4xl lg:text-5xl text-lime-400 animate-fade-in">
            SHAMIM AHMAD
          </h1>
